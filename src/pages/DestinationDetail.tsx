...
const destinationDetails: Record<string, {
  ...
  agadir: {
    ...
    aboutFr: "Une ville moderne de stations balnéaires reconstruite après le tremblement de terre de 1960. Agadir offre 10km de plage de sable, golf de classe mondiale et un climat doux toute l'année.",
    why: "Perfect for beach holidays, family vacations, and winter sun escapes. Agadir is also Suenos Travel's home base.",
    whyFr: "Parfait pour les vacances de plage, les vacances en famille et les escapades au soleil d'hiver. Agadir est aussi le siège de Suenos Travel.",
...
export default function DestinationDetail() {
  ...
  return (
    <>
      <Helmet>
        <title>{dest.name} | Suenos Travel</title>
        <meta name="description" content={dest.about} />
      </Helmet>
        ...
        <div className="relative h-[350px] md:h-[450px]">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 md:p-8">
            <div className="max-w-7xl mx-auto">
              ...
              <h1 className="font-serif text-3xl md:text-5xl font-bold text-white">{isFr ? dest.nameFr : dest.name}</h1>
            </div>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2 space-y-10">
              <div>
                ...
                <p className="text-[#4B5563] leading-relaxed">{isFr ? dest.aboutFr : dest.about}</p>
              </div>
              <div>
